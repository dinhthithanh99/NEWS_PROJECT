            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a  href="{{route('cate.postAdd')}}""><i class="fa fa-home"></i> Add Category </a>
                   
                  </li>
                  <li><a href="{{route('ShowCate')}}"><i class="fa fa-edit"></i> Show Category </a>
                    
                  </li>
                  <li><a href="{{route('postAddNew')}}"><i class="fa fa-desktop"></i> Add News</a>
                    
                  </li>
                  <li><a href="{{route('getshowNew')}}"><i class="fa fa-table"></i> Show News</a>
