...
<div class="container-fluid bg-faded fh5co_padd_mediya padding_786">
    <div class="container padding_786">
        <nav class="navbar navbar-toggleable-md navbar-light ">
            ...
            <a class="navbar-brand" href="#"><img src="{{ asset('public/user/images/logo.png')}}" style=" padding: 0px; margin: opx; width: 80px; height: 70px;" alt="img" class="mobile_logo_width"/></a>
            <div class="container animate-box fadeIn animated-fast" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    @foreach($cate as $cat)
                    <li class="nav-item ">
                        <a class="nav-link" href="blog.html">{{$cat['name']}} <span class="sr-only"></span></a>
                    </li>
                    @endforeach
                    
                    <li class="nav-item ">
                        <a class="nav-link" href="Contact_us.html">Contact <span class="sr-only"></span></a>
                    </li>
                </ul>
            </div>
        </nav>
